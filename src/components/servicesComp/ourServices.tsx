    ...
    <section className="py-[100px]">
      <div className="flex flex-col justify-center items-center">
        ...
        <div
          ...
          data-aos-delay="300"
        >
          <h1 className="text-[68px] leading-[70px] tracking-[-2.04px] text-dark-color font-be-vietnam-pro font-medium text-center">
      ...
      <div className="box-border">
        <div className="grid grid-cols-3 gap-[40px]">
          {servicesInfo.map((item) => (
            <div className=" box-border" key={`services-page-${item.id}`}>
              ...
              <div className="box border rounded-[20px] p-[16px_16px_35px] relative w-full bg-white">
                ...
                <div className="pt-[20px] px-[24px] ">
                  ...
                  <h2 className="text-dark-color tracking-[-0.28px] mt-[2px] text-[28px] leading-[34px] font-be-vietnam-pro font-[600] ">
                    {item.t2}
                  </h2>
                </div>
              </div>
